      ...
      if (isSignUp) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: 'Welcome to Afya Band. Redirecting to dashboard...',
          });
          navigate('/dashboard');
        }
      } else {
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-primary-foreground/20 rounded-xl flex items-center justify-center">
                <Activity className="text-primary-foreground w-7 h-7" />
              </div>
              <span className="text-3xl font-bold text-primary-foreground">Afya Band</span>
            </div>
            <p className="text-primary-foreground/80">
              {isSignUp ? 'Create your account to start tracking' : 'Sign in to access your health data'}
            </p>
          </div>
